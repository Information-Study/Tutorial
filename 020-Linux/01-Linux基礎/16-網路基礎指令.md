...
> sudo atrm <編號>
> ```
> 這是 `netplan try` 的手動版本。見 [[18-排程工作]]。
...
>
> 見 [[05-curl-與HTTP除錯]] 與 [[04-效能瓶頸排查方法論]]。
...
> 下一步應該去看 [[07-Nginx-日誌與除錯]] 的 `upstream_response_time`、
...
- [[03-ss-netstat-與lsof]] — 連線與埠的深入排查
- [[05-curl-與HTTP除錯]] — `curl` 的完整進階用法
- [[06-dig-與DNS排查]] — DNS 問題的系統化排查
- [[01-tcpdump-基礎抓包]] — 上述工具都查不出來時的下一步
- [[02-防火牆-ufw基礎與實務]] — 防火牆設定
- [[04-連接埠速查]] — 各服務預設埠與是否該對外
- [[01-網路架構基礎]] — VLAN、子網切分與企業網路分層
