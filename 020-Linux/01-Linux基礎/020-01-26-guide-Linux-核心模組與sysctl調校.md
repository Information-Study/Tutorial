...
在 [[020-01-17-cmd-Linux-systemd服務管理]] 提過的 `MemoryMax=`、`CPUQuota=`、`IOWeight=` 全是 cgroup。
執行中臨時調整：
...
> - Redis：`tcp-backlog`
> 見 [[060-02-02-08-guide-Nginx-效能調校]]。
...
| `modprobe: Operation not permitted` | Secure Boot 擋未簽章模組 | MOK 簽署（見 [[020-01-25-guide-Linux-開機流程與GRUB救援]]） |
...
- [[020-01-17-cmd-Linux-systemd服務管理]] — `Limit*=`、`MemoryMax=` 與沙箱
- [[020-01-25-guide-Linux-開機流程與GRUB救援]] — initramfs 重建、DKMS 與 Secure Boot
- [[020-01-15-cmd-Linux-磁碟分割與掛載]] — swappiness 與 swap
- [[020-01-10-cmd-Linux-程序管理與訊號]] — OOM 與 cgroup 的關係
- [[060-02-02-08-guide-Nginx-效能調校]] — 核心參數與 Nginx 設定的配對
- [[090-06-03-guide-TWGCB-Linux項目分類詳解]] — 核心參數的合規要求
- [[060-01-03-04-guide-監控-效能瓶頸排查方法論]] — 調校前的量測
