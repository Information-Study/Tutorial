...
- [[070-01-03-cmd-前端-JavaScript基礎]] —— 函式、箭頭函式、物件
- [[070-01-07-cmd-前端-瀏覽器開發者工具]] —— 這篇的排錯全靠 Network 分頁
...
延續 [[070-01-03-cmd-前端-JavaScript基礎]] 的主機清單，這次改成真的向後端要資料。
...
正式環境還是要用解法一或二。詳見 [[070-01-06-svc-前端-前端建置工具與套件管理]]。
...
> [!danger] 非同步請求特有的四個風險
> 1. ★★★★★ **不要把 API 金鑰放前端**（見 [[070-01-03-cmd-前端-JavaScript基礎]]）——
...
- [[070-01-03-cmd-前端-JavaScript基礎]] —— 函式、型別、DOM 與 XSS
- [[070-01-07-cmd-前端-瀏覽器開發者工具]] —— Network 分頁的完整用法、Copy as cURL
- [[070-01-06-svc-前端-前端建置工具與套件管理]] —— Vite 開發代理與環境變數
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] —— SPA 的 API 代理實作
