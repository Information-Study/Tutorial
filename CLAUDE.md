...
每個章節有 `00-<章節>-索引.md`。`重建索引.py` 會自動遞迴處理所有層級。

```
00-索引/                     首頁、學習路徑、速查表

10-基礎概論/       01-計算機概論  02-計算機網路
20-Linux/          01-Linux基礎  02-Linux伺服器管理
25-Windows/        01-Windows系統管理
30-網路與網路設備/ 01-網路基礎與設備  02-機房與硬體管理
35-虛擬機與容器/   01-虛擬化平台  02-容器化
40-軟體與開發工具/ 01-常用工具  02-Web伺服器  03-應用執行環境
                   04-資料庫與資料儲存               ← 02 含 MyGuard/Angie
50-系統及工具開發/ 01-前端基礎  02-Vue與Nuxt  03-PHP與Laravel
                   04-Python開發  05-Shell與PowerShell
                   06-自動化測試  07-n8n流程自動化
60-專案管理/       01-專案管理基礎  02-需求與規格管理
                   03-版本與發布管理  04-協作與知識管理
70-資訊安全/       01-憑證與PKI  02-資訊安全  03-Wazuh資安監控
                                                    ← 02 含 TWGCB 子章
80-系統維運/       01-監控與日誌分析  02-維運實務
85-AI人工智慧/     01-AI服務基礎  02-Ollama  03-OpenWebUI  04-ComfyUI
90-雲端與架構/     01-雲端與架構
95-實務案例/       01-專案部署實戰                   ← LXMP 全套整合
