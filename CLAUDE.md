...
- 規模目標：約 389 篇（現有 197 篇骨架，規劃新增約 151 篇）
- 語言：**繁體中文**，技術名詞保留英文原文
...
50-Web伺服器/  51-應用執行環境/ 52-資料庫/ 53-AI服務/ 服務
60-憑證與PKI/  61-資訊安全/                           資安
70-監控與日誌/ 71-維運實務/                           維運
80-專案部署實戰/                                      應用
90-附錄/  99-收件匣/
...
1. **MyGuard**：需要套件庫網址、GPG 金鑰、套件名稱、設定方式才能撰寫
2. **TWGCB**：要對應哪一版基準
3. **實機環境**：Cisco／Juniper／PVE／OPNsense／Windows AD 是否有可驗證環境
