...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[03-Laravel-佇列排程與Supervisor]]"]
updated: 2026-08-28
---
...
- [[02-Laravel-Nginx與PHP-FPM設定]] — FPM 與 OPcache
...
- [[05-Laravel-Filament部署]] — Filament 後台的部署
- [[06-Laravel-Nova部署]] — Nova 的授權與部署
- [[07-Laravel-正式環境安全檢查表]] — 上線前的完整檢查
- [[06-部署自動化]] — CI/CD 與自動化
- [[05-PHP-OPcache與效能]] — OPcache 的深入設定
- [[03-Laravel-佇列排程與Supervisor]] — 佇列的重啟
