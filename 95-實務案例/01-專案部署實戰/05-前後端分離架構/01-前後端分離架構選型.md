...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-部署共通觀念]]", "[[02-Vue-SPA路由與API代理]]"]
updated: 2026-08-28
---
...
- [[01-部署共通觀念]] — LXMP 架構全貌
- [[02-Vue-SPA路由與API代理]] — API 代理的三種模式
...
- [[02-Laravel-API後端部署]] — API 後端的專屬設定
- [[03-跨網域與CORS設定]] — CORS 的完整說明
- [[04-認證串接-Sanctum與JWT]] — 認證的實作細節
- [[05-Nginx-前後端流量分流設定]] — Nginx 的分流設定
- [[06-Vue-Laravel完整部署實戰]] — 完整的實戰範例
- [[01-部署共通觀念]] — LXMP 架構全貌
