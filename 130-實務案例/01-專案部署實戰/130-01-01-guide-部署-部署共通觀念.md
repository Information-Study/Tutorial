...
- [[060-02-01-guide-Web-Web伺服器概論]] — 反向代理與靜態／動態
- [[060-01-01-01-guide-Git-觀念與初次設定]] — Git 基本操作
...
| 層 | 元件 | 本手冊對應章節 |
| --- | --- | --- |
| TLS / 反代 | Nginx（主線）／Apache2 | [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] |
| WAF | ModSecurity + OWASP CRS | [[090-04-01-svc-WAF-WAF概念與ModSecurity安裝]] |
| 憑證 | 自建 CA／Let's Encrypt | [[090-01-08-guide-PKI-用自建CA簽發伺服器憑證]] |
| PHP | PHP-FPM 8.3 + OPcache | [[060-03-01-02-guide-PHP-FPM設定與Pool調校]] |
| 後端 | Laravel 11 + Nova／Filament | [[130-01-04-05-guide-Laravel-Filament部署]] |
| 前端 | Vue 3（SPA）／Nuxt 3（SSR） | [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] |
| 程序管理 | PM2／systemd／Supervisor | [[060-03-02-03-guide-PM2-程序管理入門]] |
| 資料庫 | MySQL 8 | [[060-04-01-01-svc-MySQL-安裝與初始化]] |
| 快取／佇列 | Redis | [[060-04-04-svc-DB-Redis快取入門]] |
...
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — LXMP 後端的完整設定
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] — 前端靜態部署
- [[130-01-03-02-guide-Nuxt-SSR與PM2部署]] — SSR 與 PM2
- [[130-01-05-06-guide-Vue-Laravel完整部署實戰]] — 從 GitHub 專案開始的完整實戰
- [[130-01-06-guide-部署-部署自動化]] — Git hook / GitHub Actions / Deployer
