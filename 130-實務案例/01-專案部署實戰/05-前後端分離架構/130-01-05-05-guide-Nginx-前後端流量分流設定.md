...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-05-01-guide-前後端-前後端分離架構選型]]", "[[060-02-02-03-guide-Nginx-location與rewrite]]"]
updated: 2026-08-28
---
...
- [[130-01-05-01-guide-前後端-前後端分離架構選型]] — 拓撲的選擇
- [[060-02-02-03-guide-Nginx-location與rewrite]] — location 的基本語法
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — PHP-FPM 的設定
...
| **子目錄 SPA 白畫面** ★★★ | `alias` 或 `base` 設定 | 見 [[130-01-02-02-guide-Vue-SPA路由與API代理]] |
...
- [[130-01-05-09-guide-前後端-前後端分離常見問題排查]] — 問題排查
- [[060-02-02-03-guide-Nginx-location與rewrite]] — location 的完整語法
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — PHP-FPM 的設定
- [[060-02-02-08-guide-Nginx-效能調校]] — 限流與快取的進階設定
- [[090-04-03-svc-ModSecurity-規則調校與誤判處理]] — WAF 的調校
