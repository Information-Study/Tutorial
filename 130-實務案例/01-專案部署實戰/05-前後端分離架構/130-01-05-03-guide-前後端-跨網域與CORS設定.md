...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-05-01-guide-前後端-前後端分離架構選型]]"]
updated: 2026-08-28
---
...
- [[130-01-05-02-guide-Laravel-API後端部署]] — API 設定
...
- [[130-01-05-04-guide-認證串接-Sanctum與JWT]] — 認證與 CORS 的互動
- [[130-01-05-05-guide-Nginx-前後端流量分流設定]] — Nginx 的分流
- [[130-01-05-09-guide-前後端-前後端分離常見問題排查]] — 完整的問題排查
- [[130-01-05-01-guide-前後端-前後端分離架構選型]] — 用同源避開 CORS
- [[130-01-05-02-guide-Laravel-API後端部署]] — API 的完整設定
- [[090-03-02-guide-應用安全-應用層安全]] — CORS 與 CSRF 的關係
