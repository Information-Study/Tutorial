...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-05-06-guide-Vue-Laravel完整部署實戰]]", "[[130-01-03-02-guide-Nuxt-SSR與PM2部署]]"]
updated: 2026-08-28
---
...
- [[130-01-05-06-guide-Vue-Laravel完整部署實戰]] — LXMP 的完整流程
- [[130-01-03-02-guide-Nuxt-SSR與PM2部署]] — PM2 與 SSR 的管理
- [[130-01-03-03-guide-Nuxt-Nginx反向代理與快取]] — Nginx 層的快取
...
- [[130-01-05-06-guide-Vue-Laravel完整部署實戰]] — SPA 版本的完整實戰
- [[130-01-05-08-guide-前後端-前後端分離的環境變數與建置流程]] — 環境變數的管理
- [[130-01-05-09-guide-前後端-前後端分離常見問題排查]] — 問題排查總表
- [[130-01-03-03-guide-Nuxt-Nginx反向代理與快取]] — 快取的完整設定
- [[130-01-03-02-guide-Nuxt-SSR與PM2部署]] — PM2 的深入設定
- [[130-01-03-01-guide-Nuxt-渲染模式與部署選型]] — 渲染模式的選擇
