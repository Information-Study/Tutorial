...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-05-01-guide-前後端-前後端分離架構選型]]", "[[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]]"]
updated: 2026-08-28
---
...
- [[130-01-05-01-guide-前後端-前後端分離架構選型]] — 拓撲與認證的選擇
...
- [[130-01-05-03-guide-前後端-跨網域與CORS設定]] — CORS 的完整設定
