...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-05-01-guide-前後端-前後端分離架構選型]]", "[[130-01-05-03-guide-前後端-跨網域與CORS設定]]"]
updated: 2026-08-28
---
...
- [[130-01-05-01-guide-前後端-前後端分離架構選型]] — 認證方式的選擇
- [[130-01-05-03-guide-前後端-跨網域與CORS設定]] — 跨網域的 cookie
...
- [[130-01-05-09-guide-前後端-前後端分離常見問題排查]] — 認證問題的排查
- [[130-01-05-03-guide-前後端-跨網域與CORS設定]] — 跨網域的 cookie
- [[130-01-04-07-guide-Laravel-正式環境安全檢查表]] — 認證的安全檢查
- [[090-03-02-guide-應用安全-應用層安全]] — 認證與授權的通用原則
