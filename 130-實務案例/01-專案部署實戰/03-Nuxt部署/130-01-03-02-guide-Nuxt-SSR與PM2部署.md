...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-03-01-guide-Nuxt-渲染模式與部署選型]]", "[[060-03-02-03-guide-PM2-程序管理入門]]"]
updated: 2026-08-28
---
...
- [[130-01-03-01-guide-Nuxt-渲染模式與部署選型]] — 確定要用 SSR
- [[060-03-02-03-guide-PM2-程序管理入門]] — PM2 基本操作
...
- [[130-01-03-03-guide-Nuxt-Nginx反向代理與快取]] — Nginx 層的設定
- [[130-01-03-04-guide-Nuxt-Docker部署]] — 容器化部署
- [[130-01-05-07-guide-Nuxt-Laravel-SSR完整部署實戰]] — 與 Laravel 整合
- [[060-03-02-04-guide-PM2-進階設定與部署]] — PM2 的進階功能
- [[020-02-02-05-svc-systemd-PM2與systemd整合]] — 兩者的整合方式
- [[130-01-03-01-guide-Nuxt-渲染模式與部署選型]] — 確認是否真的需要 SSR
