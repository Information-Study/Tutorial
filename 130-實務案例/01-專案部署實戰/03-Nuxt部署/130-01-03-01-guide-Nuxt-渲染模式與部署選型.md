...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-01-guide-部署-部署共通觀念]]", "[[130-01-02-01-guide-Vue-建置與Nginx靜態部署]]"]
updated: 2026-08-28
---
...
- [[130-01-01-guide-部署-部署共通觀念]] — 部署佈局
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] — Vue SPA 的部署方式
...
- [[130-01-03-02-guide-Nuxt-SSR與PM2部署]] — SSR 模式的完整部署
- [[130-01-03-03-guide-Nuxt-Nginx反向代理與快取]] — Nginx 層的設定與快取
- [[130-01-03-04-guide-Nuxt-Docker部署]] — 容器化部署
- [[130-01-05-07-guide-Nuxt-Laravel-SSR完整部署實戰]] — 與 Laravel 後端整合
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] — SPA 的部署方式
- [[130-01-01-guide-部署-部署共通觀念]] — 部署佈局與原子切換
