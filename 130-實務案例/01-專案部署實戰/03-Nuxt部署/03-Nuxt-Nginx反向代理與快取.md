...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[02-Nuxt-SSR與PM2部署]]", "[[04-Nginx-反向代理與負載平衡]]"]
updated: 2026-08-28
---
...
- [[02-Nuxt-SSR與PM2部署]] — Node 服務已在 127.0.0.1:3000 執行
- [[04-Nginx-反向代理與負載平衡]] — proxy_pass 基礎
- [[08-Nginx-效能調校]] — 快取與壓縮
...
- [[07-Nuxt-Laravel-SSR完整部署實戰]] — 與 Laravel 整合的完整實戰
- [[02-Nuxt-SSR與PM2部署]] — Node 服務的管理
- [[08-Nginx-效能調校]] — 快取與壓縮的進階設定
- [[04-Nginx-反向代理與負載平衡]] — upstream 的完整用法
- [[05-Nginx-靜態資源與快取]] — 靜態資源的快取策略
