...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[02-Nuxt-SSR與PM2部署]]", "[[03-Vue-Docker部署]]"]
updated: 2026-08-28
---
...
- [[02-Nuxt-SSR與PM2部署]] — SSR 的程序管理概念
- [[03-Vue-Docker部署]] — 靜態 SPA 的容器化
- [[03-Dockerfile撰寫]] — Dockerfile 語法
...
- [[07-Nuxt-Laravel-SSR完整部署實戰]] — 完整的整合實戰
- [[03-Vue-Docker部署]] — SPA 容器化（對照）
- [[03-Nuxt-Nginx反向代理與快取]] — proxy 層的完整設定
- [[06-Docker-多階段建置與映像優化]] — 映像優化
- [[08-Docker-安全實務]] — 容器安全加固
- [[02-Compose-多服務編排實戰]] — Compose 的進階用法
