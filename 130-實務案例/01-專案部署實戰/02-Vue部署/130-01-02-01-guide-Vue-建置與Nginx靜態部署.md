...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-01-guide-部署-部署共通觀念]]", "[[060-02-02-02-guide-Nginx-設定語法與虛擬主機]]"]
updated: 2026-08-28
---
...
- [[130-01-01-guide-部署-部署共通觀念]] — `releases`/`current` 佈局與原子切換
- [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] — Nginx 基本設定
...
# （MyGuard 套件庫的 nginx 內建，見 [[060-02-05-00-idx-MyGuard與Angie]]）
brotli_static on;
```
...
| **CORS 錯誤** ★★ | 前後端不同源且後端沒設 | 見 [[130-01-05-03-guide-前後端-跨網域與CORS設定]] |
...
- [[130-01-02-02-guide-Vue-SPA路由與API代理]] — 路由與 API 代理的細節
- [[130-01-02-03-guide-Vue-Docker部署]] — 容器化部署
- [[130-01-05-06-guide-Vue-Laravel完整部署實戰]] — 與 Laravel 後端整合的完整實戰
- [[130-01-01-guide-部署-部署共通觀念]] — releases/current 佈局
- [[060-02-02-08-guide-Nginx-效能調校]] — 壓縮與快取的進階設定
- [[130-01-05-03-guide-前後端-跨網域與CORS設定]] — 前後端分離的 CORS
