...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-Vue-建置與Nginx靜態部署]]"]
updated: 2026-08-28
---
...
- [[01-Vue-建置與Nginx靜態部署]] — 基本部署
- [[03-Nginx-location與rewrite]] — location 匹配順序
...
- [[03-跨網域與CORS設定]] — 跨域時的完整 CORS 設定
- [[05-Nginx-前後端流量分流設定]] — 更複雜的分流情境
- [[06-Vue-Laravel完整部署實戰]] — 完整的整合實戰
- [[03-Nginx-location與rewrite]] — location 匹配的完整規則
- [[04-Nginx-反向代理與負載平衡]] — proxy_pass 的進階用法
