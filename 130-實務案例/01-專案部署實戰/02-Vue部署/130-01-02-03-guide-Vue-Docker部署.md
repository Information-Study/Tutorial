...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-02-01-guide-Vue-建置與Nginx靜態部署]]", "[[050-02-01-03-guide-Docker-Dockerfile撰寫]]"]
updated: 2026-08-28
---
...
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] — Nginx 設定與快取策略
- [[050-02-01-03-guide-Docker-Dockerfile撰寫]] — Dockerfile 基本語法
...
- [[130-01-03-04-guide-Nuxt-Docker部署]] — SSR 的容器化（差異很大）
- [[130-01-05-06-guide-Vue-Laravel完整部署實戰]] — 完整的整合實戰
- [[050-02-01-03-guide-Docker-Dockerfile撰寫]] — Dockerfile 的完整語法
- [[050-02-01-06-svc-Docker-多階段建置與映像優化]] — 映像優化的進階技巧
- [[050-02-01-08-guide-Docker-安全實務]] — 容器安全加固
- [[130-01-02-01-guide-Vue-建置與Nginx靜態部署]] — 傳統部署方式
