...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-04-01-guide-Laravel-環境需求與安裝]]", "[[060-03-01-02-guide-PHP-FPM設定與Pool調校]]"]
updated: 2026-08-28
---
...
- [[130-01-04-01-guide-Laravel-環境需求與安裝]] — 專案已部署
- [[060-03-01-02-guide-PHP-FPM設定與Pool調校]] — FPM 基礎
- [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] — Nginx 基礎
...
- [[130-01-04-04-guide-Laravel-快取最佳化與部署流程]] — OPcache 與部署流程
- [[130-01-04-07-guide-Laravel-正式環境安全檢查表]] — 完整的上線檢查
- [[060-03-01-02-guide-PHP-FPM設定與Pool調校]] — FPM 的深入調校
- [[060-02-02-03-guide-Nginx-location與rewrite]] — location 匹配規則
- [[090-04-01-svc-WAF-WAF概念與ModSecurity安裝]] — ModSecurity 的完整設定
