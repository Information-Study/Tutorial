...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]]"]
updated: 2026-08-28
---
...
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — Web 層已就緒
- [[130-01-04-01-guide-Laravel-環境需求與安裝]] — Redis 已設定
...
- [[130-01-04-04-guide-Laravel-快取最佳化與部署流程]] — 完整的部署流程
- [[130-01-04-07-guide-Laravel-正式環境安全檢查表]] — 上線前檢查
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — Web 層設定
- [[060-04-04-svc-DB-Redis快取入門]] — Redis 的設定與調校
- [[020-01-18-guide-Linux-排程工作]] — cron 與 systemd timer 的完整說明
- [[100-01-03-guide-日誌-系統監控與告警]] — 監控與告警的整合
