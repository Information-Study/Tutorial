...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[130-01-01-guide-部署-部署共通觀念]]", "[[060-03-01-01-guide-PHP-安裝與多版本管理]]"]
updated: 2026-08-28
---
...
- [[060-03-01-01-guide-PHP-安裝與多版本管理]] — PHP 的安裝
- [[060-04-01-01-svc-MySQL-安裝與初始化]] — MySQL 的準備
...
★★ 接下來：
  ① 設定 PHP-FPM pool  → [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]]
  ② 設定 Nginx         → 同上
  ③ 簽發並部署憑證     → [[090-01-08-guide-PKI-用自建CA簽發伺服器憑證]]
  ④ 設定佇列與排程     → [[130-01-04-03-guide-Laravel-佇列排程與Supervisor]]
  ⑤ 執行安全檢查表     → [[130-01-04-07-guide-Laravel-正式環境安全檢查表]]
...
- [[130-01-04-02-guide-Laravel-Nginx與PHP-FPM設定]] — 下一步：Web 伺服器設定
- [[130-01-04-03-guide-Laravel-佇列排程與Supervisor]] — 佇列與排程
- [[130-01-04-04-guide-Laravel-快取最佳化與部署流程]] — 部署流程與快取
