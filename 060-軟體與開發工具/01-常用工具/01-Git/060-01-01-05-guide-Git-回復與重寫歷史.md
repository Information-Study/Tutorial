...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-03-guide-Git-分支與合併]]"]
updated: 2026-08-28
---
...
- [[060-01-01-03-guide-Git-分支與合併]] — 分支與 HEAD 的概念
...
詳見 [[060-01-01-03-guide-Git-分支與合併]] 的互動式 rebase 段落。
...
# ═══════════ 【第 2 步】通知 ═══════════
# · 通知所有協作者
# · 若涉及個資或公務系統，依 [[090-07-04-guide-資安實踐-資安事件應變流程]] 通報
...
- [[060-01-01-03-guide-Git-分支與合併]] — 互動式 rebase 整理歷史
- [[060-01-01-07-guide-Git-進階技巧]] — stash、bisect、hooks
- [[060-01-01-09-guide-Git-團隊規範與實戰情境]] — 誤推、誤刪的團隊處理
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — 密碼與金鑰的正確存放
- [[090-07-04-guide-資安實踐-資安事件應變流程]] — 機密外洩的通報流程
- [[060-01-01-02-guide-Git-基本工作流程]] — `.gitignore` 與提交前檢查
