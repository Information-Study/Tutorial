...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-03-guide-Git-分支與合併]]", "[[020-02-01-02-cmd-SSH-金鑰認證與ssh-agent]]"]
updated: 2026-08-28
---
...
> 見 [[060-01-01-01-guide-Git-觀念與初次設定]]：
> ```ini
> # ~/.gitconfig
...
> [!tip] 完整的部署流程見 [[130-01-00-idx-部署實戰]]
> 這裡只示範 Git 的部分，
...
- [[060-01-01-03-guide-Git-分支與合併]] — 分支策略與衝突處理
- [[060-01-01-08-guide-Git-伺服器端與自動部署]] — 自架 Git 遠端與 push 即部署
- [[060-01-01-09-guide-Git-團隊規範與實戰情境]] — PR 規範與誤推處理
- [[020-02-01-02-cmd-SSH-金鑰認證與ssh-agent]] — SSH 金鑰的完整說明
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — Token 與金鑰的安全存放
- [[130-01-00-idx-部署實戰]] — 從 Git 專案部署到正式環境
