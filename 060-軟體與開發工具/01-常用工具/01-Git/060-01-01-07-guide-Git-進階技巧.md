...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-05-guide-Git-回復與重寫歷史]]"]
updated: 2026-08-28
---
...
- [[060-01-01-05-guide-Git-回復與重寫歷史]] — reset、revert、reflog
- [[060-01-01-03-guide-Git-分支與合併]] — 分支與 rebase
...
# ⚠ 這會【改寫歷史】，見 [[060-01-01-05-guide-Git-回復與重寫歷史]]
```
...
- [[060-01-01-05-guide-Git-回復與重寫歷史]] — reflog、filter-repo
- [[060-01-01-08-guide-Git-伺服器端與自動部署]] — 伺服器端 hooks 與自動部署
- [[060-01-01-09-guide-Git-團隊規範與實戰情境]] — 團隊規範與意外處理
- [[060-01-01-03-guide-Git-分支與合併]] — rebase 與衝突處理
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — 機密掃描與存放
- [[060-01-03-04-guide-監控-效能瓶頸排查方法論]] — 效能問題的系統化排查
