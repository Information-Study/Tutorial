...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-09-guide-Git-團隊規範與實戰情境]]"]
updated: 2026-08-28
---
...
> [!warning] 先讀 [[060-01-01-09-guide-Git-團隊規範與實戰情境]] 的策略比較
...
- [[060-01-01-09-guide-Git-團隊規範與實戰情境]] — 三種策略的比較與選擇
- [[060-01-01-03-guide-Git-分支與合併]] — merge、rebase、衝突
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 標籤與語意化版號
...
- [[060-01-01-09-guide-Git-團隊規範與實戰情境]] — 三種策略的比較與團隊規範
- [[060-01-01-03-guide-Git-分支與合併]] — merge、rebase、衝突處理
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 標籤與語意化版號
- [[060-01-01-08-guide-Git-伺服器端與自動部署]] — 標籤觸發部署
- [[080-03-02-guide-發布-分支策略與git-flow]] — 從專案管理角度看分支策略
- [[080-03-03-guide-發布-發布流程與變更時窗]] — 發布的制度面
