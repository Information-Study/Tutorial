...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-04-guide-Git-遠端協作]]", "[[060-01-01-07-guide-Git-進階技巧]]"]
updated: 2026-08-28
---
...
> [!tip] 這一篇是 LXMP 部署的前置
> [[130-01-00-idx-部署實戰]] 會用到這裡建立的部署機制。
> 本篇先把「程式碼怎麼安全地送到伺服器上」講清楚。

## 前置知識

- [[060-01-01-04-guide-Git-遠端協作]] — SSH 金鑰與 Deploy Key
- [[060-01-01-07-guide-Git-進階技巧]] — hooks
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 依標籤部署
...
- [[130-01-00-idx-部署實戰]] — **LXMP 全套的完整部署實戰**
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 依標籤部署與回退
- [[060-01-01-04-guide-Git-遠端協作]] — Deploy Key 與 SSH 設定
- [[060-01-01-07-guide-Git-進階技巧]] — hooks 的完整說明
- [[130-01-06-guide-部署-部署自動化]] — CI/CD 與部署工具
- [[090-05-09-guide-資安設備-日誌集中與SIEM]] — 部署稽核紀錄
- [[090-07-11-guide-資安實踐-委外與供應鏈資安]] — 廠商的部署權限管控
