...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-01-08-guide-Git-伺服器端與自動部署]]"]
updated: 2026-08-28
---
...
> 本篇比較三種策略並說明「怎麼選」，
> **git-flow 的完整流程與指令**見 [[060-01-01-10-guide-Git-flow完整實戰]]。

## 前置知識

- [[060-01-01-08-guide-Git-伺服器端與自動部署]] — 伺服器端 hooks
- [[060-01-01-03-guide-Git-分支與合併]] — 分支與合併
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 版本與發布
...
> 並在**伺服器端的 `pre-receive`** 做最終把關（見 [[060-01-01-08-guide-Git-伺服器端與自動部署]]）。
...
# ═══════ 【第 2 步】通報 ═══════
# 涉及個資或公務系統 → 依 [[090-07-04-guide-資安實踐-資安事件應變流程]] 通報

# ═══════ 【第 3 步】清除歷史 ═══════
# 見 [[060-01-01-05-guide-Git-回復與重寫歷史]] 的 git filter-repo
...
> ```
>
> **納入半年一次的權限審查**（見 [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]]）。
...
- [[060-01-01-10-guide-Git-flow完整實戰]] — git-flow 的完整流程與指令
- [[060-01-01-08-guide-Git-伺服器端與自動部署]] — 伺服器端強制檢查
- [[060-01-01-05-guide-Git-回復與重寫歷史]] — 意外的救援手段
- [[060-01-01-06-guide-Git-標籤與版本發布]] — 版本規範
- [[090-07-11-guide-資安實踐-委外與供應鏈資安]] — 委外的完整資安要求
- [[090-07-10-guide-資安實踐-資安政策文件與制度]] — 把規範寫成正式文件
