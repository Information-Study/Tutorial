...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-04-03-guide-ss-netstat-與lsof]]"]
updated: 2026-08-28
---
...
- [[060-01-04-03-guide-ss-netstat-與lsof]] — **★★ 自己的機器用 `ss` 更準確**
...
- [[060-01-04-03-guide-ss-netstat-與lsof]] — **★★★ 自己的機器用 `ss` 更準確**
- [[060-01-04-01-guide-tcpdump-基礎抓包]] — 驗證掃描結果
- [[090-02-02-guide-防火牆-ufw基礎與實務]] — 防火牆規則的設定
- [[090-02-08-guide-防護-系統強化與稽核]] — Lynis、CIS 基準
- [[090-01-12-guide-PKI-憑證生命週期管理]] — TLS 設定與憑證監控
- [[040-02-11-guide-機房-資訊設備盤點]] — 資產管理制度
