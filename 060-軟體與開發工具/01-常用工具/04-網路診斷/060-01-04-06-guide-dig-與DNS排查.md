...
- [[020-01-16-cmd-Linux-網路基礎指令]] — 網路基礎
- [[060-01-04-05-guide-curl-與HTTP除錯]] — `time_namelookup` 慢時往這裡查
...
- [[060-01-04-05-guide-curl-與HTTP除錯]] — `time_namelookup` 慢時從這裡開始
- [[020-01-16-cmd-Linux-網路基礎指令]] — 網路基礎
- [[060-01-04-03-guide-ss-netstat-與lsof]] — 連線狀態
- [[060-01-04-01-guide-tcpdump-基礎抓包]] — 抓 DNS 封包（port 53）
- [[090-01-12-guide-PKI-憑證生命週期管理]] — DNS-01 驗證與 CAA
- [[020-01-20-guide-Linux-環境變數與設定檔]] — `/etc/hosts` 與 `resolv.conf`
