...
- [[01-tmux-工作階段管理]] — **★★★ 概念相通，功能更強**
- [[17-systemd服務管理]] — 正式服務用 systemd，不要用 screen
- [[03-終端機與Shell入門]] — 終端機基礎
- [[27-硬體資訊與裝置管理]] — `/dev` 與裝置權限
- [[11-資訊設備盤點]] — console 記錄與變更管理
- [[04-現代CLI工具集]] — 其他實用工具
