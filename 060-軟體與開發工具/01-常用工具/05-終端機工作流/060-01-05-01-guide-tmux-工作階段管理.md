...
- [[020-01-10-cmd-Linux-程序管理與訊號]] — 程序與訊號
...
>
> ★★★★ 正式服務一律用 systemd（見 [[020-01-17-cmd-Linux-systemd服務管理]]）
> ```
...
- [[060-01-05-02-guide-screen-快速上手]] — 另一個選擇（★ 舊系統上更常見）
- [[060-01-05-03-guide-終端機-Bash與Zsh效率設定]] — shell 的效率設定
- [[020-01-17-cmd-Linux-systemd服務管理]] — **★★★★ 正式服務用這個，不要用 tmux**
- [[020-01-03-cmd-Linux-終端機與Shell入門]] — 終端機基礎
- [[060-01-02-04-guide-編輯器-遠端編輯與VSCode-Remote]] — 遠端工作流的另一種選擇
- [[060-01-02-03-guide-Vim-進階與設定]] — tmux + vim 的組合
