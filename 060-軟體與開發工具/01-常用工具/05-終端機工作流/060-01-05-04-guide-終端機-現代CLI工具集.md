...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-01-05-03-guide-終端機-Bash與Zsh效率設定]]"]
updated: 2026-08-28
---
...
- [[060-01-05-03-guide-終端機-Bash與Zsh效率設定]] — shell 設定
- [[020-01-12-cmd-Linux-文字處理三劍客]] — grep / sed / awk 的基礎
...
- [[020-01-12-cmd-Linux-文字處理三劍客]] — **★★★★ grep / sed / awk 一定要會**
- [[060-01-05-03-guide-終端機-Bash與Zsh效率設定]] — shell 設定與 alias
- [[020-01-07-cmd-Linux-尋找檔案與內容]] — `find` 與 `grep` 的完整用法
- [[060-01-04-05-guide-curl-與HTTP除錯]] — 搭配 jq 處理 API 回應
- [[060-01-05-01-guide-tmux-工作階段管理]] — 終端機工作流
- [[060-01-03-03-guide-監控-資源診斷工具集]] — 系統診斷工具
