...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[020-02-01-02-cmd-SSH-金鑰認證與ssh-agent]]", "[[020-02-01-03-svc-SSH-客戶端設定檔]]"]
updated: 2026-08-28
---
...
- [[020-02-01-03-svc-SSH-客戶端設定檔]] — `~/.ssh/config` 與 ProxyJump
- [[060-01-02-02-cmd-Vim-基礎操作]] — 沒有 GUI 時的後備方案
...
- [[020-02-01-02-cmd-SSH-金鑰認證與ssh-agent]] — 金鑰與 agent
- [[020-02-01-03-svc-SSH-客戶端設定檔]] — `ProxyJump` 完整說明
- [[060-01-02-02-cmd-Vim-基礎操作]] — 沒有 GUI 時的方案
- [[060-01-06-02-guide-rsync-同步與備份]] — 本機編輯 + 同步
- [[130-01-01-guide-部署-部署共通觀念]] — 為什麼正式環境不該直接編輯
- [[130-01-06-guide-部署-部署自動化]] — 正確的做法
- [[060-01-05-01-guide-tmux-工作階段管理]] — 保住斷線的工作階段
