...
- [[060-01-02-01-guide-Nano-快速上手]] — 比較好上手的選擇
...
>   :%s,/var/www/old,/var/www/new,g
>
> ★ sed 也是一樣的規則（見 [[020-01-12-cmd-Linux-文字處理三劍客]]）
> ```
...
>      → ★ 用 sudoedit（見 [[060-01-02-01-guide-Nano-快速上手]]）
>
> ② ★★★ swap 檔會外洩敏感資料
...
- [[060-01-02-03-guide-Vim-進階與設定]] — `.vimrc`、外掛、多視窗、巨集
- [[060-01-02-01-guide-Nano-快速上手]] — 比較好上手的選擇
- [[020-01-12-cmd-Linux-文字處理三劍客]] — 批次修改用 sed 更適合
- [[020-01-03-cmd-Linux-終端機與Shell入門]] — 終端機基礎
- [[020-01-25-guide-Linux-開機流程與GRUB救援]] — 救援模式常常只有 `vi`
