...
- [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] — map、變數、繼承規則
...
> Node 用 **BullMQ**。
> 見 [[130-01-04-03-guide-Laravel-佇列排程與Supervisor]]。
...
- [[060-02-02-05-guide-Nginx-靜態資源與快取]] — proxy_cache 與快取策略
- [[060-02-02-08-guide-Nginx-效能調校]] — worker、連線數、HTTP/2 與 HTTP/3
- [[060-02-02-09-guide-Nginx-安全設定]] — 限流、IP 封鎖、WAF
- [[060-02-02-03-guide-Nginx-location與rewrite]] — location 比對規則
- [[060-03-02-03-guide-PM2-程序管理入門]] — Node.js 後端的程序管理
- [[060-03-01-02-guide-PHP-FPM設定與Pool調校]] — PHP-FPM 的 pool 設定
