...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-02-02-01-guide-Nginx-安裝與目錄結構]]"]
updated: 2026-08-28
---
...
- [[060-02-02-01-guide-Nginx-安裝與目錄結構]] — 目錄結構與 `nginx -T`
...
> 這通常不是你想要的（見 [[060-02-02-01-guide-Nginx-安裝與目錄結構]] 的「預設拒絕」）。
...
- [[060-02-02-03-guide-Nginx-location與rewrite]] — 下一步：location 的比對規則
- [[060-02-02-04-guide-Nginx-反向代理與負載平衡]] — proxy_pass 與 upstream
- [[060-02-02-06-guide-Nginx-HTTPS與Certbot]] — TLS 設定
- [[060-02-02-09-guide-Nginx-安全設定]] — 完整的安全加固
- [[060-02-02-01-guide-Nginx-安裝與目錄結構]] — 目錄結構與 `nginx -T`
- [[090-03-02-guide-應用安全-應用層安全]] — 安全標頭的完整說明
