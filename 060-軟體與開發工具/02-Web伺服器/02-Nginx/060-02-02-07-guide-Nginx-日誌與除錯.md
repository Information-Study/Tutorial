...
- [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] — 變數與設定語法
- [[020-01-19-guide-Linux-日誌系統]] — journalctl、rsyslog、logrotate 的基礎
...
> ```
> 見 [[100-01-02-guide-日誌-日誌集中與輪替]] 與 [[090-08-00-idx-Wazuh資安監控]]。
>
> **中央日誌系統的三個要求**：
> ①**傳輸加密**（TLS，避免日誌在網路上明文）；
...
- [[060-02-02-08-guide-Nginx-效能調校]] — 依日誌發現的瓶頸做調校
- [[060-02-02-09-guide-Nginx-安全設定]] — 從日誌中發現的攻擊如何防護
- [[100-01-01-00-idx-GoAccess]] — 把日誌變成視覺化報表
- [[100-01-02-guide-日誌-日誌集中與輪替]] — 中央日誌系統
- [[020-01-19-guide-Linux-日誌系統]] — journalctl、rsyslog、logrotate 基礎
- [[060-02-02-04-guide-Nginx-反向代理與負載平衡]] — 502/504 的完整排查
