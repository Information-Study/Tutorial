...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-02-03-01-guide-Apache-安裝與目錄結構]]"]
updated: 2026-08-28
---
...
- [[060-02-03-01-guide-Apache-安裝與目錄結構]] — 目錄結構與 `a2*` 工具
...
> （與 Nginx 的情況完全相同，見 [[060-02-02-04-guide-Nginx-反向代理與負載平衡]]）。
>
> ```apache
> RequestHeader set X-Forwarded-Proto "https"
> RequestHeader set X-Forwarded-Port  "443"
...
- [[060-02-03-03-guide-Apache-模組與MPM]] — 下一步：MPM 選擇與模組
- [[060-02-03-04-guide-Apache-htaccess與Rewrite]] — mod_rewrite 完整說明
- [[060-02-03-05-guide-Apache-HTTPS設定]] — TLS 設定
- [[060-02-03-06-guide-Apache-與PHP整合]] — mod_php vs PHP-FPM
- [[060-02-02-02-guide-Nginx-設定語法與虛擬主機]] — 對照 Nginx 的做法
