...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-02-03-06-guide-Apache-與PHP整合]]"]
updated: 2026-08-28
---
...
- [[060-02-03-06-guide-Apache-與PHP整合]] — PHP-FPM 與權限隔離
- [[060-02-03-03-guide-Apache-模組與MPM]] — MPM 調校
- [[060-02-02-09-guide-Nginx-安全設定]] — 通用的 Web 安全觀念（本篇不重複）
...
> 詳見 [[060-02-02-05-guide-Nginx-靜態資源與快取]]。
...
> **這與 Nginx 的問題完全相同**，見 [[060-02-02-05-guide-Nginx-靜態資源與快取]]。
> ```
...
- [[060-02-03-06-guide-Apache-與PHP整合]] — PHP 層的加固與權限隔離
- [[060-02-03-03-guide-Apache-模組與MPM]] — MPM 調校與 MaxRequestWorkers
- [[060-02-03-05-guide-Apache-HTTPS設定]] — TLS 與憑證
- [[060-02-02-09-guide-Nginx-安全設定]] — 通用的 Web 安全觀念
- [[090-04-00-idx-ModSecurity]] — WAF（Apache 之上的一層）
- [[090-02-05-guide-防護-Fail2ban入侵防護]] — 依日誌自動封鎖
- [[060-02-04-guide-Web-Nginx與Apache選型與共存]] — 兩者並用的架構
