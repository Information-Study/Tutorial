...
> 見 [[060-02-03-06-guide-Apache-與PHP整合]]。
...
echo -e "\n✓ 完成。接著調校 PHP-FPM 的 pool（見 [[060-03-01-02-guide-PHP-FPM設定與Pool調校]]）"
...
- [[060-02-03-06-guide-Apache-與PHP整合]] — mod_php 遷移到 PHP-FPM 的完整流程
- [[060-02-03-07-guide-Apache-安全與效能]] — 完整的效能與安全調校
- [[060-03-01-02-guide-PHP-FPM設定與Pool調校]] — FPM 端的 worker 調校
- [[060-02-02-08-guide-Nginx-效能調校]] — 對照 Nginx 的做法
