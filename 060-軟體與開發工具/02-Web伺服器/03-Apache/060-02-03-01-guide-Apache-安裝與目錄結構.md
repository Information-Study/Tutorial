...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[060-02-01-guide-Web-Web伺服器概論]]"]
updated: 2026-08-28
---
...
- [[060-02-01-guide-Web-Web伺服器概論]] — 請求流程與 LXMP 架構
...
> —— 見 [[060-02-04-guide-Web-Nginx與Apache選型與共存]]。
...
- [[060-02-03-02-guide-Apache-VirtualHost設定]] — 下一步：虛擬主機設定
- [[060-02-03-03-guide-Apache-模組與MPM]] — prefork / worker / event 的選擇
- [[060-02-03-04-guide-Apache-htaccess與Rewrite]] — .htaccess 與 mod_rewrite
- [[060-02-04-guide-Web-Nginx與Apache選型與共存]] — 兩者並用的架構
- [[060-02-02-01-guide-Nginx-安裝與目錄結構]] — 對照 Nginx 的做法
