...
- [[060-02-03-02-guide-Apache-VirtualHost設定]] — VirtualHost 與容器
- [[060-02-02-03-guide-Nginx-location與rewrite]] — 對照 Nginx 的做法（觀念相通）
...
> **真正的防護要靠**：
> ①**應用層的輸入驗證與參數化查詢**；
> ②**ModSecurity + OWASP CRS**（見 [[090-04-00-idx-ModSecurity]]）；
> ③限流與 fail2ban。
...
- [[060-02-03-05-guide-Apache-HTTPS設定]] — TLS 與 HTTPS 轉址
- [[060-02-03-06-guide-Apache-與PHP整合]] — php_value 為什麼在 FPM 下無效
- [[060-02-03-07-guide-Apache-安全與效能]] — AllowOverride 的效能影響
- [[060-02-02-03-guide-Nginx-location與rewrite]] — 對照 Nginx 的做法
- [[090-04-00-idx-ModSecurity]] — 真正的 WAF 防護
