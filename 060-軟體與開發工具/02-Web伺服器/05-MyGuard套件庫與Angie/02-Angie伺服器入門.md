...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-MyGuard套件庫介紹]]", "[[02-Nginx-設定語法與虛擬主機]]"]
updated: 2026-08-28
---
...
- [[01-MyGuard套件庫介紹]] — 套件庫的加入
- [[02-Nginx-設定語法與虛擬主機]] — **★★★ NGINX 的設定語法完全通用**
...
- [[01-MyGuard套件庫介紹]] — 套件庫的加入與風險評估
- [[03-autocert自動憑證模組]] — **★★★ NGINX 版的自動憑證（MyGuard 自製）**
- [[07-動態模組管理]] — 模組的安裝與載入
- [[08-MyGuard實戰組合]] — 完整的實戰配置
- [[02-Nginx-設定語法與虛擬主機]] — **★★★ 設定語法完全通用**
- [[06-Nginx-HTTPS與Certbot]] — certbot 的傳統做法
