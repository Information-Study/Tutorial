...
status: 完成
distro: [ubuntu]
prerequisites: ["[[04-http-shield攻擊攔截]]"]
updated: 2026-08-28
---
...
- [[04-http-shield攻擊攔截]] — shield 的攔截機制
- [[05-Fail2ban入侵防護]] — fail2ban 的做法（★ 用來對照）
...
- [[04-http-shield攻擊攔截]] — 已知漏洞利用的攔截
- [[05-Fail2ban入侵防護]] — **★★★ 防火牆層的封鎖（互補）**
- [[08-Nginx-效能調校]] — `limit_req` / `limit_conn` 的基礎限流
- [[09-Nginx-安全設定]] — NGINX 的安全基礎
- [[08-MyGuard實戰組合]] — 完整的實戰配置
- [[04-Wazuh-FIM檔案完整性監控]] — 集中式的資安監控
