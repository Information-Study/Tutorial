...
status: 完成
distro: [ubuntu]
prerequisites: ["[[060-02-05-01-guide-MyGuard-MyGuard套件庫介紹]]", "[[060-02-02-09-guide-Nginx-安全設定]]"]
updated: 2026-08-28
---
...
- [[060-02-02-09-guide-Nginx-安全設定]] — NGINX 的安全設定基礎
- [[090-04-01-svc-WAF-WAF概念與ModSecurity安裝]] — **★★★ 完整 WAF 的做法**（★ 用來對照）
...
> 它是**縱深防禦的一層**，不是唯一的一層。
> 應用程式的安全檢查（見 [[130-01-04-07-guide-Laravel-正式環境安全檢查表]]）一樣要做。
...
- [[090-04-01-svc-WAF-WAF概念與ModSecurity安裝]] — **★★★ 完整 WAF（互補）**
