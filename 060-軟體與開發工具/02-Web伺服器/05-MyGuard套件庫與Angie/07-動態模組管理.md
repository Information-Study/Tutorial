...
status: 完成
distro: [ubuntu]
prerequisites: ["[[01-MyGuard套件庫介紹]]", "[[01-Nginx-安裝與目錄結構]]"]
updated: 2026-08-28
---
...
- [[03-autocert自動憑證模組]] — autocert 的載入
- [[04-http-shield攻擊攔截]] — shield 的載入
- [[14-套件管理]] — APT 的相依與 pinning
