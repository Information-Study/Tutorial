...
status: 完成
distro: [ubuntu]
prerequisites: ["[[060-02-02-05-guide-Nginx-靜態資源與快取]]", "[[060-02-02-08-guide-Nginx-效能調校]]"]
updated: 2026-08-28
---
...
- [[060-02-02-05-guide-Nginx-靜態資源與快取]] — **★★★ `proxy_cache` 的基礎**
- [[060-02-02-08-guide-Nginx-效能調校]] — gzip 與效能設定
...
- [[060-02-02-05-guide-Nginx-靜態資源與快取]] — **★★★ `proxy_cache` 的基礎**
- [[060-02-02-08-guide-Nginx-效能調校]] — gzip、HTTP/2、連線調校
- [[130-01-05-07-guide-Nuxt-Laravel-SSR完整部署實戰]] — **★★★★ SSR 的快取污染防護**
- [[130-01-03-03-guide-Nuxt-Nginx反向代理與快取]] — 微快取的做法
- [[060-04-04-svc-DB-Redis快取入門]] — 應用層快取
