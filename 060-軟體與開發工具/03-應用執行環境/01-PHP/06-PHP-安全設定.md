...
- [[03-PHP-ini重要參數]] — php.ini 的設定方式
- [[02-PHP-FPM設定與Pool調校]] — pool 的 `php_admin_value`
- [[09-Nginx-安全設定]] 或 [[07-Apache-安全與效能]] — Web 伺服器端
...
- [[09-Nginx-安全設定]] — Web 伺服器層的防護
- [[07-Apache-安全與效能]] — Apache 的對應設定
- [[02-PHP-FPM設定與Pool調校]] — 獨立 pool 與權限隔離
- [[03-PHP-ini重要參數]] — 其他安全參數
- [[02-應用層安全]] — OWASP Top 10
- [[00-ModSecurity-索引]] — WAF
- [[04-Wazuh-FIM檔案完整性監控]] — 檔案異動監控
