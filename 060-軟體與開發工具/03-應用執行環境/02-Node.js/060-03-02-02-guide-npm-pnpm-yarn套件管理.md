...
- [[060-03-02-01-guide-Node-安裝與版本管理]] — Node 安裝與 corepack
...
- [[060-03-02-03-guide-PM2-程序管理入門]] — 下一步：程序管理
- [[060-03-02-01-guide-Node-安裝與版本管理]] — corepack 與 packageManager
- [[060-03-01-04-guide-Composer-套件管理]] — PHP 端的對應概念
- [[070-02-00-idx-Vue與Nuxt]] — 前端框架的建置流程
