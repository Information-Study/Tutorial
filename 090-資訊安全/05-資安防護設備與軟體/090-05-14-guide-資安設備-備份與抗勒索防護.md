...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]", "[[090-03-04-guide-應用安全-備份災難復原與入侵應變]]"]
updated: 2026-08-27
---
...
- [[090-03-04-guide-應用安全-備份災難復原與入侵應變]] — 備份與 DR 的整體概念
- [[090-05-08-guide-資安設備-資料防護DLP與加密]] — **全磁碟加密不防勒索**
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 復原是縱深防禦的最後一層
...
>   }'
> ```
> 把這個檢查加進監控系統（見 [[100-01-03-guide-日誌-系統監控與告警]]）。
...
>
> 見 [[090-05-08-guide-資安設備-資料防護DLP與加密]] 與 [[090-07-07-guide-資安實踐-台灣資安法規與個資法]]。
...
- [[090-03-04-guide-應用安全-備份災難復原與入侵應變]] — 備份與 DR 的完整制度
- [[090-07-04-guide-資安實踐-資安事件應變流程]] — 遭遇勒索時的完整應變
- [[090-05-08-guide-資安設備-資料防護DLP與加密]] — 備份中的個資與加密
- [[090-05-05-guide-資安設備-端點防護AV-EDR-XDR]] — 偵測勒索病毒的行為
- [[090-05-12-guide-資安設備-零信任架構與微分段]] — 限制勒索病毒的擴散
- [[100-01-03-guide-日誌-系統監控與告警]] — 監控備份是否正常執行
- [[090-07-07-guide-資安實踐-台灣資安法規與個資法]] — 通報義務與備份的法遵要求
