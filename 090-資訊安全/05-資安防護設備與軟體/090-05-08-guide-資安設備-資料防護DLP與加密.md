...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]", "[[020-01-15-cmd-Linux-磁碟分割與掛載]]"]
updated: 2026-08-27
---
...
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 資料是所有防護的最終目標
- [[020-01-15-cmd-Linux-磁碟分割與掛載]] — 磁碟與分割的基礎
- [[090-03-01-guide-應用安全-TLS憑證與HTTPS實務]] — 傳輸中的加密
...
> 見 [[090-07-05-guide-資安實踐-ISO27001與ISMS]]。
...
> - **存取行為監控**（他一次下載一萬筆 → 告警）
> - **法律與人事管理**（保密協定、離職面談）
> - **UEBA**（使用者行為分析，見 [[090-05-09-guide-資安設備-日誌集中與SIEM]]）
...
> | --- | --- |
> | 設備遺失／被偷 | **全磁碟加密** |
> | 系統被入侵 | EDR、修補、最小權限（[[090-05-05-guide-資安設備-端點防護AV-EDR-XDR]]） |
> | 勒索病毒 | **異地離線備份**（[[090-05-14-guide-資安設備-備份與抗勒索防護]]） |
...
| 加密了還是被勒索病毒加密 | **全磁碟加密不防勒索**（系統開機後已解密） | 需要**異地離線備份**（[[090-05-14-guide-資安設備-備份與抗勒索防護]]） |
...
> - **設備安全管理**（← **全磁碟加密**屬於這一項）
> - 資料安全稽核機制
> - **使用紀錄、軌跡資料及證據保存**（← 見 [[090-05-09-guide-資安設備-日誌集中與SIEM]]）
> - 個人資料安全維護之整體持續改善
>
> **外洩時的義務**：
...
- [[090-05-14-guide-資安設備-備份與抗勒索防護]] — 加密不防勒索，備份才防
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — 金鑰管理的細節
- [[090-03-01-guide-應用安全-TLS憑證與HTTPS實務]] — 傳輸中的加密
- [[090-05-09-guide-資安設備-日誌集中與SIEM]] — 存取行為監控與 UEBA
- [[090-07-07-guide-資安實踐-台灣資安法規與個資法]] — 個資法的法遵要求
- [[090-07-05-guide-資安實踐-ISO27001與ISMS]] — 資產清冊與分級的管理制度
- [[090-07-11-guide-資安實踐-委外與供應鏈資安]] — 委外銷毀的要求
