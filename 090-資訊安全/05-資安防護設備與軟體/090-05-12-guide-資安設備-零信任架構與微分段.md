...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-07-guide-資安設備-身分存取管理IAM與MFA]]", "[[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]"]
updated: 2026-08-27
---
...
- [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] — **身分是零信任的核心**
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 零信任是縱深防禦的現代形式
- [[010-02-16-guide-網概-VLAN與網路分段]] — 傳統的網路分段
...
>
> **實作方式**：
> - 交換器的 **Private VLAN / Port Isolation**（見 [[010-02-16-guide-網概-VLAN與網路分段]]）
...
> - [ ] 條件式存取（地點、裝置、風險）
> - [ ] **管理員帳號與日常帳號分離**
> - [ ] 見 [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]]
>
> **【階段二】裝置**
> - [ ] 裝置盤點與納管
> - [ ] **EDR 全面部署**
...
- [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] — **身分是零信任的核心**
- [[090-05-13-guide-資安設備-網路存取控制NAC與802.1X]] — 裝置進網前的驗證
- [[010-02-16-guide-網概-VLAN與網路分段]] — 傳統網路分段的基礎
- [[090-05-02-guide-資安設備-防火牆與次世代防火牆]] — 零信任不取代邊界防護
- [[090-05-09-guide-資安設備-日誌集中與SIEM]] — 持續監控與信任判定的資料來源
- [[090-05-05-guide-資安設備-端點防護AV-EDR-XDR]] — 裝置合規狀態的來源
- [[090-05-16-guide-資安設備-資安設備選型與導入實務]] — ZTNA/SASE 的選型
