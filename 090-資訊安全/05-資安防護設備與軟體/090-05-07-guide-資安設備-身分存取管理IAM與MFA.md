...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]", "[[020-01-09-cmd-Linux-使用者與群組管理]]"]
updated: 2026-08-27
---
...
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 身分是縱深防禦的關鍵層
- [[020-01-09-cmd-Linux-使用者與群組管理]] — Linux 的帳號與權限基礎
- [[010-01-18-guide-計概-資訊安全初步]] — 密碼與驗證的基本觀念
...
> **身分才是新的邊界。**
>
> 這是 [[090-05-12-guide-資安設備-零信任架構與微分段]] 的核心前提 ——
...
| **Kerberos** | Windows AD 網域內 | 票證機制，見 [[030-01-00-idx-Windows系統管理-Windows管理]] |
...
> - IdP 的所有登入與設定變更**送到 SIEM**（見 [[090-05-09-guide-資安設備-日誌集中與SIEM]]）
...
- [[090-05-12-guide-資安設備-零信任架構與微分段]] — 身分是零信任的核心
- [[090-07-02-guide-資安實踐-密碼與帳號管理實務]] — 密碼政策的細節
- [[090-05-09-guide-資安設備-日誌集中與SIEM]] — 身分事件的監控
- [[020-02-01-07-svc-SSH-安全強化]] — Linux 端的實作
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — 服務帳號的密碼管理
- [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]] — 權限盤點的稽核要求
- [[090-07-12-guide-資安實踐-資安意識與社交工程防範]] — MFA 疲勞與釣魚的人員面防護
