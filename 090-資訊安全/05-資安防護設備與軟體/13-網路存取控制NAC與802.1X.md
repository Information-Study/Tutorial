...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[16-網概-VLAN與網路分段]]", "[[07-身分存取管理IAM與MFA]]"]
updated: 2026-08-27
---
...
- [[16-網概-VLAN與網路分段]] — VLAN 的基礎
- [[07-身分存取管理IAM與MFA]] — 認證的基本概念
- [[01-TLS憑證與HTTPS實務]] — EAP-TLS 需要憑證基礎
...
> 什麼都做不了。
>
> **這就是「微分段」與 NAC 的結合**（見 [[12-零信任架構與微分段]]）。
...
>
> **必須搭配**：
> - **微分段**（見 [[12-零信任架構與微分段]]）—— VLAN 內也要管控
> - **EDR**（見 [[05-端點防護AV-EDR-XDR]]）
> - **持續的合規檢查**（不只在連線時檢查一次）
...
- [[12-零信任架構與微分段]] — NAC 通過之後的內部管控
- [[16-網概-VLAN與網路分段]] — VLAN 基礎
- [[07-身分存取管理IAM與MFA]] — 認證的整體架構
- [[05-端點防護AV-EDR-XDR]] — 與 NAC 整合的自動隔離
- [[15-實體與OT-IoT安全設備]] — IoT 裝置的隔離與實體安全
- [[09-日誌集中與SIEM]] — 認證日誌與 SOAR 自動化
- [[00-網路設備-索引]] — 交換器設定的基礎
