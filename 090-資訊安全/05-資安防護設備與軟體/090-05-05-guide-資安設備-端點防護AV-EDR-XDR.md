...
tags: [群組/資訊安全, 安全/防護設備, 主題/端點防護]
category: 資安防護設備與軟體
difficulty: 進階
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]", "[[010-01-18-guide-計概-資訊安全初步]]"]
updated: 2026-08-27
---
...
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 端點在整體架構中的位置
- [[010-01-18-guide-計概-資訊安全初步]] — 惡意程式的種類
...
> [!note] 現代攻擊的起點幾乎都在端點
> 回顧殺傷鏈（見 [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]]）：
> ```
...
| **USB 管制** | 見 [[010-01-12-guide-計概-輸入輸出與週邊設備]] |
...
> 4. 廠商的資安認證與合約條款
>
> 見 [[090-07-07-guide-資安實踐-台灣資安法規與個資法]] 與 [[090-07-11-guide-資安實踐-委外與供應鏈資安]]。
...
> - **agent 離線超過 N 天要告警**
> - 把「安裝 EDR」納入 [[020-02-03-01-svc-標準化-新機建置標準流程]]
...
- [[090-05-01-guide-資安設備-資安全景圖與縱深防禦]] — 端點在整體架構中的位置
- [[090-05-03-guide-資安設備-入侵偵測與防禦IDS-IPS]] — HIDS 與 EDR 的關係
- [[090-05-09-guide-資安設備-日誌集中與SIEM]] — EDR 告警要送到哪裡
- [[090-05-06-guide-資安設備-郵件與網頁閘道防護]] — 攔截「遞送」階段
- [[090-07-03-guide-資安實踐-弱點與修補管理流程]] — **端點防護的基礎**（進階）
- [[090-07-04-guide-資安實踐-資安事件應變流程]] — 發現入侵後怎麼做（進階）
- [[090-02-08-guide-防護-系統強化與稽核]] — auditd 與系統加固（進階）
