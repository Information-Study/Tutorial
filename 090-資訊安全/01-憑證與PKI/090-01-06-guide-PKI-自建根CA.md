...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-01-05-guide-PKI-自簽憑證快速產生]]"]
updated: 2026-08-28
---
...
- [[090-01-05-guide-PKI-自簽憑證快速產生]] — 自簽憑證的限制
...
> ```
> **SAN 由 CA 用 `-extfile` 明確指定**（見 [[090-01-08-guide-PKI-用自建CA簽發伺服器憑證]]）：
> ```bash
...
★★★ 接下來的重要步驟：
  ...
  ② 【建立中繼 CA】（見 [[090-01-07-guide-PKI-自建中繼CA與憑證鏈]]）
...
| **簽發的憑證沒有 SAN** | 沒有用 `-extfile` | 見 [[090-01-08-guide-PKI-用自建CA簽發伺服器憑證]] |
...
> ```
> ③**最好用自動派送（GPO / MDM）避免人為錯誤**（見 [[090-01-09-guide-PKI-根憑證派送與信任]]）。
>
...
- [[090-01-07-guide-PKI-自建中繼CA與憑證鏈]] — 下一步：建立中繼 CA
- [[090-01-08-guide-PKI-用自建CA簽發伺服器憑證]] — 日常的簽發作業
- [[090-01-09-guide-PKI-根憑證派送與信任]] — 把根憑證派送到各平台
- [[090-01-12-guide-PKI-憑證生命週期管理]] — CRL、撤銷與監控
- [[090-01-05-guide-PKI-自簽憑證快速產生]] — 為什麼不該用自簽憑證
- [[090-01-01-guide-PKI-PKI與憑證基礎]] — 憑證鏈與信任模型
