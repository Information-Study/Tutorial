...
tags: [群組/資訊安全, 安全/實踐規範, 主題/帳號管理]
category: 資安實踐與規範
difficulty: 入門
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-07-01-guide-資安實踐-資安基本原則與實踐]]", "[[020-01-09-cmd-Linux-使用者與群組管理]]"]
updated: 2026-08-28
---
...
- [[090-07-01-guide-資安實踐-資安基本原則與實踐]] — 最小權限與可歸責性
- [[020-01-09-cmd-Linux-使用者與群組管理]] — Linux 帳號的基礎
- [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] — IAM 的整體架構
...
> - 在**風險評鑑文件中說明**你的考量
>
> 見 [[090-06-00-idx-TWGCB]] 與 [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]]。
...
# 前面放 Nginx 反向代理 + HTTPS（見 51-Web伺服器 章節）
...
- [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] — MFA、SSO 與特權帳號管理
- [[090-07-01-guide-資安實踐-資安基本原則與實踐]] — 最小權限與可歸責性
- [[090-03-03-guide-應用安全-機密管理與金鑰保護]] — 服務帳號密碼的儲存
- [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]] — 帳號審查的稽核要求
- [[090-07-10-guide-資安實踐-資安政策文件與制度]] — 把密碼政策寫成文件
- [[090-07-12-guide-資安實踐-資安意識與社交工程防範]] — 密碼相關的社交工程
- [[020-01-09-cmd-Linux-使用者與群組管理]] — Linux 帳號操作
