...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-07-01-guide-資安實踐-資安基本原則與實踐]]"]
updated: 2026-08-28
---
...
- [[090-07-01-guide-資安實踐-資安基本原則與實踐]] — 資安原則
- [[090-07-05-guide-資安實踐-ISO27001與ISMS]] — 管理制度的框架
...
| 功能 | 縮寫 | 核心問題 | 對應本手冊 |
| --- | --- | --- | --- |
| **GOVERN 治理** ★ | GV | **誰負責？政策是什麼？風險胃納多大？** | [[090-07-10-guide-資安實踐-資安政策文件與制度]]、[[090-07-05-guide-資安實踐-ISO27001與ISMS]] |
| **IDENTIFY 識別** | ID | **我們有什麼？面臨什麼風險？** | [[090-07-03-guide-資安實踐-弱點與修補管理流程]]（資產清單） |
| **PROTECT 保護** | PR | **怎麼防止事件發生？** | [[090-05-00-idx-資安防護設備]] 大部分 |
| **DETECT 偵測** | DE | **怎麼知道發生了？** | [[090-05-09-guide-資安設備-日誌集中與SIEM]]、[[090-05-03-guide-資安設備-入侵偵測與防禦IDS-IPS]] |
| **RESPOND 回應** | RS | **發生了要怎麼處理？** | [[090-07-04-guide-資安實踐-資安事件應變流程]] |
| **RECOVER 復原** | RC | **怎麼恢復正常？** | [[090-05-14-guide-資安設備-備份與抗勒索防護]] |
...
| # | 控制 | 一句話 | 對應本手冊 |
| --- | --- | --- | --- |
| **1** | **企業資產盤點與控制** | **你有什麼設備？** | [[090-07-03-guide-資安實踐-弱點與修補管理流程]] |
| **2** | **軟體資產盤點與控制** | **裝了什麼軟體？** | [[020-02-03-02-ref-標準化-基準設定與範本化]] |
| **3** | **資料保護** | 資料分級、加密、DLP | [[090-05-08-guide-資安設備-資料防護DLP與加密]] |
| **4** | **企業資產與軟體的安全組態** | 加固設定 | [[090-02-08-guide-防護-系統強化與稽核]]、[[090-06-00-idx-TWGCB]] |
| **5** | **帳號管理** | 帳號生命週期 | [[090-07-02-guide-資安實踐-密碼與帳號管理實務]] |
| **6** | **存取控制管理** | 最小權限、**MFA** | [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] |
| **7** | **持續弱點管理** | 掃描與修補 | [[090-07-03-guide-資安實踐-弱點與修補管理流程]] |
| **8** | **稽核日誌管理** | 收集與保存日誌 | [[090-05-09-guide-資安設備-日誌集中與SIEM]] |
| **9** | **電子郵件與瀏覽器防護** | SEG、SWG、DNS 過濾 | [[090-05-06-guide-資安設備-郵件與網頁閘道防護]] |
| **10** | **惡意程式防護** | AV / EDR | [[090-05-05-guide-資安設備-端點防護AV-EDR-XDR]] |
| **11** | **資料復原** | **備份與還原演練** | [[090-05-14-guide-資安設備-備份與抗勒索防護]] |
| **12** | **網路基礎設施管理** | 網路設備的安全管理 | [[040-01-00-idx-網路設備]] |
| **13** | **網路監控與防禦** | IDS/IPS、網路分段 | [[090-05-03-guide-資安設備-入侵偵測與防禦IDS-IPS]]、[[090-05-12-guide-資安設備-零信任架構與微分段]] |
| **14** | **資安意識與技能訓練** | 教育訓練 | [[090-07-12-guide-資安實踐-資安意識與社交工程防範]] |
| **15** | **服務供應商管理** | 委外與供應鏈 | [[090-07-11-guide-資安實踐-委外與供應鏈資安]] |
| **16** | **應用軟體安全** | 安全開發 | [[090-03-02-guide-應用安全-應用層安全]] |
| **17** | **事件回應管理** | 應變流程 | [[090-07-04-guide-資安實踐-資安事件應變流程]] |
| **18** | **滲透測試** | 驗證防護是否有效 | [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] |
...
| --- | --- | --- | --- | --- | --- |
| **資產清單** | 1.1, 2.1 | ID.AM | A.5.9 | 資產盤點 | [[090-07-03-guide-資安實踐-弱點與修補管理流程]] |
| **MFA** | 6.3, 6.5 | PR.AA | A.8.5 | 存取控制 | [[090-05-07-guide-資安設備-身分存取管理IAM與MFA]] |
| **自動修補** | 7.3, 7.4 | PR.PS | A.8.8 | 漏洞管理 | [[090-07-03-guide-資安實踐-弱點與修補管理流程]] |
| **日誌收集** | 8.2 | DE.CM | A.8.15 | **日誌保存 6 個月** | [[090-05-09-guide-資安設備-日誌集中與SIEM]] |
| **備份 + 演練** | 11.2, 11.5 | RC.RP | A.8.13 | 營運持續 | [[090-05-14-guide-資安設備-備份與抗勒索防護]] |
| **隔離的備份副本** | 11.4 | RC.RP | A.8.13 | — | [[090-05-14-guide-資安設備-備份與抗勒索防護]] |
| **教育訓練** | 14.1-14.6 | PR.AT | A.6.3 | **年度時數要求** | [[090-07-12-guide-資安實踐-資安意識與社交工程防範]] |
| **事件應變** | 17.1-17.4 | RS.MA | A.5.24-5.28 | **通報時限** | [[090-07-04-guide-資安實踐-資安事件應變流程]] |
| **供應商管理** | 15.1 | GV.SC | A.5.19-5.23 | 委外管理 | [[090-07-11-guide-資安實踐-委外與供應鏈資安]] |
| **弱點掃描** | 7.5, 7.6 | ID.RA | A.8.8 | 定期檢測 | [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] |
| **滲透測試** | 18.1-18.5 | ID.RA | A.8.8 | **依責任等級** | [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] |
| **安全組態** | 4.1-4.12 | PR.PS | A.8.9 | **TWGCB** | [[090-06-00-idx-TWGCB]] |
| **DNS 過濾** | 9.2 | PR.IR | A.8.23 | — | [[090-05-06-guide-資安設備-郵件與網頁閘道防護]] |
| **網路分段** | 12.2 | PR.IR | A.8.22 | 網路區隔 | [[090-05-12-guide-資安設備-零信任架構與微分段]] |
...
- [[090-07-05-guide-資安實踐-ISO27001與ISMS]] — 管理制度的框架
- [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]] — 用框架做自我檢核
- [[090-06-00-idx-TWGCB]] — 台灣的組態基準（相當於 CIS Benchmark）
- [[090-02-08-guide-防護-系統強化與稽核]] — CIS Control 4 的技術實作
- [[020-02-03-02-ref-標準化-基準設定與範本化]] — 建立自己的組態基準
- [[090-05-16-guide-資安設備-資安設備選型與導入實務]] — 用框架決定採購優先序
- [[090-07-01-guide-資安實踐-資安基本原則與實踐]] — 框架背後的原則
