...
tags: [群組/資訊安全, 安全/實踐規範, 主題/修補管理]
category: 資安實踐與規範
difficulty: 進階
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[090-05-10-guide-資安設備-弱點管理與滲透測試工具]]", "[[090-07-01-guide-資安實踐-資安基本原則與實踐]]"]
updated: 2026-08-28
---
...
> [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] 講的是**工具怎麼用**（nmap、OpenVAS、Trivy）。
> **這一篇講的是「流程與制度」** —— 掃描出來之後要怎麼辦。

## 前置知識

- [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] — 掃描工具與 CVE/CVSS/EPSS/KEV
- [[090-07-01-guide-資安實踐-資安基本原則與實踐]] — 風險與權衡
...
>
> ```
> ① 用網路掃描找出「網路上有什麼」（見 [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]]）
...
> 不回答「多有可能被利用」。**
>
> 完整說明見 [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]]。
...
> - 資料庫更新後**效能大幅下降**
> - Windows 更新後**列印功能異常**
> - 更新後 **BitLocker 要求還原金鑰**（見 [[090-05-08-guide-資安設備-資料防護DLP與加密]]）
...
> - 有沒有異常
>
> 這是稽核的必查項目。見 [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]]。
...
- [[090-05-10-guide-資安設備-弱點管理與滲透測試工具]] — 掃描工具與 CVE/CVSS/EPSS/KEV 的細節
- [[090-05-04-guide-資安設備-Web應用防火牆WAF]] — 虛擬修補的實作
- [[090-07-09-guide-資安實踐-資安稽核與符合性檢核]] — 修補紀錄的稽核要求
- [[090-07-10-guide-資安實踐-資安政策文件與制度]] — 把修補時限寫進政策
- [[020-01-14-guide-Linux-套件管理]] — apt / dnf 的操作
- [[090-02-08-guide-防護-系統強化與稽核]] — 修補之外的系統加固
- [[090-05-16-guide-資安設備-資安設備選型與導入實務]] — 資安設備本身的修補
