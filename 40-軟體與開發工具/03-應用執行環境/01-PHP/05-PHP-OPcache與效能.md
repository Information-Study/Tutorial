...
- [[03-PHP-ini重要參數]] — php.ini 設定與生效方式
- [[02-PHP-FPM設定與Pool調校]] — FPM reload
...
- [[06-PHP-安全設定]] — PHP 層的安全加固
- [[03-PHP-ini重要參數]] — 其他效能相關參數
- [[02-PHP-FPM設定與Pool調校]] — worker 調校與 reload
- [[04-Composer-套件管理]] — autoload 最佳化
- [[05-Nginx-靜態資源與快取]] — Nginx 端的快取
- [[08-Git-伺服器端與自動部署]] — 零停機部署
