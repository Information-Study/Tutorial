...
- [[01-PHP-安裝與多版本管理]] — 多版本與設定檔位置
- [[03-Apache-模組與MPM]] 或 [[08-Nginx-效能調校]] — Web 伺服器端的調校
...
- [[06-PHP-安全設定]] — open_basedir 與 disable_functions
- [[01-PHP-安裝與多版本管理]] — 設定檔位置與多版本
- [[06-Apache-與PHP整合]] — Apache 端的整合
- [[08-Nginx-效能調校]] — Nginx 端的調校
