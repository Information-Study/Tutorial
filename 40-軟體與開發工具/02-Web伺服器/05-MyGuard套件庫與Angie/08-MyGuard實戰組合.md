...
status: 完成
distro: [ubuntu]
prerequisites: ["[[07-動態模組管理]]", "[[06-Vue-Laravel完整部署實戰]]"]
updated: 2026-08-28
---
...
- [[01-MyGuard套件庫介紹]] ~ [[07-動態模組管理]] — **★★★ 前七篇**
- [[06-Vue-Laravel完整部署實戰]] — LXMP 的部署流程
...
| **憑證申請失敗** ★★★★ | resolver / 80 埠 / 速率限制 | 見 [[03-autocert自動憑證模組]] |
...
| **升級後 nginx 起不來** ★★★★ | 模組版本不符 | 一起升級；見 [[07-動態模組管理]] |
...
- [[01-MyGuard套件庫介紹]] — 套件庫與風險評估
- [[02-Angie伺服器入門]] — Angie 的替代方案
- [[03-autocert自動憑證模組]] — 自動憑證的細節
- [[04-http-shield攻擊攔截]] — 攻擊攔截的調校
- [[05-error-abuse與sentinel]] — 限流與信譽評分
- [[06-cache-turbo與壓縮模組]] — 快取與壓縮
- [[07-動態模組管理]] — 模組的升級與管理
- [[06-Vue-Laravel完整部署實戰]] — **★★★ LXMP 的部署流程**
