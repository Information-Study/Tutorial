...
- [[02-Apache-VirtualHost設定]] — VirtualHost
- [[06-Nginx-HTTPS與Certbot]] — 憑證的通用概念（本篇不重複）

> [!tip] 憑證原理與自簽憑證鏈
> 本篇專注在 **Apache 這邊怎麼設**。
> 憑證原理、CSR、自簽憑證鏈、內部 CA 見 [[00-憑證與PKI-索引]]。
...
> 4. 若不是 A+，逐項修正
> 5. **對照 [[06-Nginx-HTTPS與Certbot]]，兩者的設定方式有什麼異同？**
...
- [[06-Apache-與PHP整合]] — 下一步：PHP 整合
- [[07-Apache-安全與效能]] — 完整加固
- [[03-Apache-模組與MPM]] — event MPM（HTTP/2 的前提）
- [[06-Nginx-HTTPS與Certbot]] — 對照 Nginx；HSTS 的完整說明
- [[00-憑證與PKI-索引]] — 憑證原理、自簽憑證鏈、內部 CA
