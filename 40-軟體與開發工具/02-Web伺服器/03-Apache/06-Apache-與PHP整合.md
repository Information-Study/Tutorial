...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[03-Apache-模組與MPM]]"]
updated: 2026-08-28
---
...
- [[03-Apache-模組與MPM]] — MPM 與 mod_php 的關係
- [[02-PHP-FPM設定與Pool調校]] — FPM 端的設定
...
| `pm.max_children` 不夠 | FPM worker 用完 | 見 [[02-PHP-FPM設定與Pool調校]] |
...
- [[07-Apache-安全與效能]] — 完整加固
- [[03-Apache-模組與MPM]] — event MPM 與 MaxRequestWorkers
- [[02-PHP-FPM設定與Pool調校]] — pm.max_children 的計算
- [[06-PHP-安全設定]] — open_basedir、disable_functions 完整說明
- [[01-PHP-安裝與多版本管理]] — ondrej PPA 與 Remi
- [[04-Nginx與Apache選型與共存]] — 兩者並用
