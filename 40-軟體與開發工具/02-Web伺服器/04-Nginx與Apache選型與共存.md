...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[09-Nginx-安全設定]]", "[[07-Apache-安全與效能]]"]
updated: 2026-08-28
---
...
- [[09-Nginx-安全設定]] — Nginx 完整設定
- [[07-Apache-安全與效能]] — Apache 完整設定
...
- [[00-Nginx-索引]] — Nginx 完整教學
- [[00-Apache-索引]] — Apache 完整教學
- [[03-Apache-模組與MPM]] — event MPM 遷移（★ 效益最大的一步）
- [[06-Apache-與PHP整合]] — mod_php → PHP-FPM
- [[04-Nginx-反向代理與負載平衡]] — proxy_pass 與標頭轉發
- [[01-Web伺服器概論]] — LXMP 整體架構
