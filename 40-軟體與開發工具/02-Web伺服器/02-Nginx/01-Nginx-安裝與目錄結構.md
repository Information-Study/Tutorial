...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-Web伺服器概論]]", "[[14-套件管理]]"]
updated: 2026-08-28
---
...
> ```
>
> 見 [[11-委外與供應鏈資安]] 與 [[03-第三方APT套件庫實務]]。
...
- [[02-Nginx-設定語法與虛擬主機]] — 下一步：設定檔語法與 server 區塊
- [[03-Nginx-location與rewrite]] — 路由規則
- [[06-Nginx-HTTPS與Certbot]] — 憑證與 HTTPS
- [[09-Nginx-安全設定]] — 完整的安全加固
- [[01-Web伺服器概論]] — 整體架構與選型
- [[03-第三方APT套件庫實務]] — MyGuard 等第三方套件庫
- [[01-Git-觀念與初次設定]] — 設定檔版控
