...
- [[07-Nginx-日誌與除錯]] — 用日誌找出瓶頸
- [[05-Nginx-靜態資源與快取]] — 壓縮與快取（**效果通常比調參數大**）
...
- [[09-Nginx-安全設定]] — 安全加固（與效能的平衡）
- [[05-Nginx-靜態資源與快取]] — 壓縮與快取（**效能提升最大的兩項**）
- [[07-Nginx-日誌與除錯]] — 用日誌找出瓶頸
- [[04-Nginx-反向代理與負載平衡]] — keepalive 與 upstream
- [[02-PHP-FPM設定與Pool調校]] — 後端的 worker 調校
- [[07-Apache-安全與效能]] — Apache 的對應調校
