...
- [[02-Nginx-設定語法與虛擬主機]] — listen、server_name
- [[03-Nginx-location與rewrite]] — location 與 return

> [!tip] 憑證的原理與自簽憑證鏈
> 本篇專注在**「怎麼在 Nginx 上把 HTTPS 設好」**。
> 憑證的原理、CSR 的產生、自簽憑證鏈的建立、內部 CA 的架設，
> 請看 [[00-憑證與PKI-索引]] 整個章節。
...
- [[00-憑證與PKI-索引]] — 憑證原理、CSR、自簽憑證鏈、內部 CA
- [[09-Nginx-安全設定]] — 安全標頭與完整加固
- [[08-Nginx-效能調校]] — HTTP/2 與 HTTP/3
- [[05-Apache-HTTPS設定]] — Apache 的對應設定
- [[03-autocert自動憑證模組]] — MyGuard 的免 certbot 方案
- [[05-TLS憑證與HTTPS實務]] — mTLS 與 SSL Labs 評分細節
