...
- [[16-網路基礎指令]] — `ip`、`ss`、`ping`
- [[03-ss-netstat-與lsof]] — 先確認連線狀態再抓包
...
- [[02-tcpdump-進階過濾與實戰]] — BPF 語法、重傳分析、TLS 排查
- [[03-ss-netstat-與lsof]] — 抓包前先看連線狀態
- [[16-網路基礎指令]] — `ip` / `ping` / `traceroute`
- [[05-curl-與HTTP除錯]] — 應用層的排查
- [[07-SSH-安全強化]] — 內部通訊加密
- [[10-憑證部署到各服務]] — 為什麼內部服務也要 TLS
