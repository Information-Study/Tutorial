...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[010-02-09-guide-網概-TCP與UDP]]", "[[010-02-11-guide-網概-DNS網域名稱系統]]"]
updated: 2026-08-27
---
...
- [[010-02-09-guide-網概-TCP與UDP]] — HTTP 建立在 TCP 之上
- [[010-02-11-guide-網概-DNS網域名稱系統]] — 先有 DNS 才知道連去哪
...
> 而不是只看那把鎖。
> 見 [[010-02-11-guide-網概-DNS網域名稱系統]] 與 [[010-01-18-guide-計概-資訊安全初步]]。
...
> ```
> **把它放進每日 cron 並設定告警。**
> 見 [[020-01-18-guide-Linux-排程工作]] 與 `60-憑證與PKI`。
...
>
> 見 `60-憑證與PKI` 與 [[090-03-01-guide-應用安全-TLS憑證與HTTPS實務]]。
...
- [[010-02-14-guide-網概-一個網頁請求的完整旅程]] — **把 DNS、TCP、TLS、HTTP 全部串起來**
- [[010-02-11-guide-網概-DNS網域名稱系統]] — 請求之前的第一步
- [[010-02-09-guide-網概-TCP與UDP]] — HTTP 底下的傳輸層
- [[010-02-10-guide-網概-連接埠與應用層協定]] — 80 與 443
- [[010-02-18-guide-網概-網路安全基礎]] — 中間人攻擊與加密
- [[090-01-00-idx-PKI-憑證與PKI]] — 憑證申請、自簽、SAN 完整教學（進階）
- [[090-03-02-guide-應用安全-應用層安全]] — 安全標頭與 OWASP（進階）
