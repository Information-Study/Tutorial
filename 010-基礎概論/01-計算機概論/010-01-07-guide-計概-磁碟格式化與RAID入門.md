...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[010-01-06-guide-計概-記憶體與儲存階層]]"]
updated: 2026-08-29
---
...
- [[010-01-06-guide-計概-記憶體與儲存階層]] — 硬碟在儲存階層中的位置
- [[010-01-03-cmd-計概-0與1和資料單位]] — 容量單位換算
...
> | 10 | 6 ÷ 2 × 8 | 24 TB | 每組 1 |
>
> ★★★ 別忘了還要乘上 0.93 的單位換算（見 [[010-01-03-cmd-計概-0與1和資料單位]]），
...
>
> 詳見 [[020-01-29-guide-Linux-網路儲存與軟體RAID]]。
...
>
> 完整說明見 [[090-05-14-guide-資安設備-備份與抗勒索防護]] 與 [[090-03-04-guide-應用安全-備份災難復原與入侵應變]]。
...
> 2. ★★★ **要不要 ECC 記憶體**：放重要資料的話要（見 [[010-01-06-guide-計概-記憶體與儲存階層]]）
...
> ```
> 完整做法見 [[020-01-29-guide-Linux-網路儲存與軟體RAID]] 與 [[100-01-03-guide-日誌-系統監控與告警]]。
...
| ★ 磁碟空間顯示比買的少 | 單位換算 + 檔案系統開銷 + 保留空間 | 正常。見 [[010-01-03-cmd-計概-0與1和資料單位]] |
...
> ★★★★ 這是資安稽核必查項目，見 [[090-05-08-guide-資安設備-資料防護DLP與加密]]。
...
> 2. ★★★★ 要遠端存取就走 **VPN**（見 [[010-02-18-guide-網概-網路安全基礎]]）
...
- [[010-01-06-guide-計概-記憶體與儲存階層]] — 硬碟在整個儲存階層的位置
- [[010-01-09-guide-計概-檔案與檔案系統]] — 檔案、路徑與副檔名
- [[010-01-03-cmd-計概-0與1和資料單位]] — 容量為什麼會「縮水」
- [[020-01-15-cmd-Linux-磁碟分割與掛載]] — Linux 上實際做分割、格式化與掛載（進階）
- [[020-01-29-guide-Linux-網路儲存與軟體RAID]] — mdadm、NFS、iSCSI 實作（進階）
- [[020-01-24-guide-進階儲存-ZFS與Btrfs]] — 快照與資料完整性校驗（進階）
- [[090-05-14-guide-資安設備-備份與抗勒索防護]] — 3-2-1-1-0 備份設計（進階）
