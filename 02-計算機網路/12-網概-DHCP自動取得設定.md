...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[06-網概-IP位址與子網路]]", "[[11-網概-DNS網域名稱系統]]"]
updated: 2026-08-27
---
...
- [[06-網概-IP位址與子網路]] — IP、遮罩、閘道
- [[11-網概-DNS網域名稱系統]] — DHCP 也會發 DNS 設定
...
- [[06-網概-IP位址與子網路]] — IP 規劃與池的切分
- [[05-網概-MAC位址與交換器]] — DHCP Snooping 與 ARP 防護
