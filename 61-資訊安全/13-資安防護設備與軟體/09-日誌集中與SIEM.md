...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-資安全景圖與縱深防禦]]", "[[19-日誌系統]]"]
updated: 2026-08-27
---
...
- [[19-日誌系統]] — journald、rsyslog、logrotate 的基礎
- [[01-資安全景圖與縱深防禦]] — 偵測層在縱深防禦中的位置
- [[03-系統監控與告警]] — 一般維運監控
...
| **XDR** | Extended Detection and Response | 廠商整合的跨層偵測（見 [[05-端點防護AV-EDR-XDR]]） |
...
> - **正式環境關閉 debug 等級的日誌**
> - 日誌的**存取權限比照個資系統**管理
> - 日誌保存與銷毀也要納入個資盤點（見 [[08-資料防護DLP與加密]]）
...
> - 怎麼防止竄改？
>
> 見 [[07-台灣資安法規與個資法]] 與 [[09-資安稽核與符合性檢核]]。
...
- [[19-日誌系統]] — journald、rsyslog、logrotate 的基礎
- [[05-端點防護AV-EDR-XDR]] — EDR 告警是最重要的日誌來源之一
- [[04-資安事件應變流程]] — 收到告警之後要做什麼
- [[07-台灣資安法規與個資法]] — 日誌保存與通報的法遵要求
- [[09-資安稽核與符合性檢核]] — 稽核會怎麼檢查日誌
- [[10-弱點管理與滲透測試工具]] — 弱點資料也該進 SIEM
- [[03-系統監控與告警]] — 一般維運監控與資安監控的分工
