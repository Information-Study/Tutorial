...
- [[02-防火牆與次世代防火牆]] — 防火牆的能力邊界
- [[01-資安全景圖與縱深防禦]] — 殺傷鏈與偵測的價值
...
- [[02-防火牆與次世代防火牆]] — 防火牆與 IDS 的分工
- [[04-Web應用防火牆WAF]] — 應用層的專用偵測
- [[05-端點防護AV-EDR-XDR]] — HIDS 的演進方向
- [[09-日誌集中與SIEM]] — **告警要送到哪裡、誰來看**
- [[16-資安設備選型與導入實務]] — 導入前的準備
- [[03-Fail2ban入侵防護]] — 輕量版的自動阻擋（進階）
- [[08-系統強化與稽核]] — auditd 與稽核設定（進階）
