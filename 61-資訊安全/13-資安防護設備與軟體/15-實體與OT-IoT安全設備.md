...
status: 完成
distro: [ubuntu, rhel]
prerequisites: ["[[01-資安全景圖與縱深防禦]]", "[[13-網路存取控制NAC與802.1X]]"]
updated: 2026-08-28
---
...
- [[13-網路存取控制NAC與802.1X]] — 裝置進網的管控
- [[12-零信任架構與微分段]] — 隔離的架構思維
- [[01-資安全景圖與縱深防禦]] — 實體層在縱深防禦的位置
...
| **時段管制** | 一般人只能在上班時段進入 |
| **立即停用** | **離職當天立刻停用**（見 [[07-身分存取管理IAM與MFA]]） |
| **與 HR 系統整合** | 人事異動自動連動 |
...
- [[13-網路存取控制NAC與802.1X]] — 用 NAC 隔離 IoT 裝置
- [[12-零信任架構與微分段]] — IoT 與 OT 的分段思維
- [[08-資料防護DLP與加密]] — 全磁碟加密與設備報廢的資料銷毀
- [[09-日誌集中與SIEM]] — 門禁記錄也該進 SIEM
- [[12-資安意識與社交工程防範]] — 社交工程的實體版本
- [[11-委外與供應鏈資安]] — 設備採購的資安要求
- [[00-機房與硬體-索引]] — 機房環境與硬體管理
